		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Projeto Netflixx",
									"targetURL": "#projetonetflixx-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projetonetflixx-display": {
								"semanticObject": "projetonetflixx",
								"action": "display",
								"description": "Jornada Programador ABAP do Zero",
								"title": "Projeto Netflixx",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projetonetflixx",
									"url": sap.ui.require.toUrl("projetonetflixx")
								}
							}
						}
					}
